...
(function() {
            ...
            if (fd.jtype == "Boolean") {
                ...
                switch (fd.type) {
                    ...
                    default:
                        ...
                        html.push(attrHtml);
                        html.push(" id='");
                        html.push(elementId + "' type='" + fd.type + "' ");//这里是用户传入的type，而不是text，这样可支持html5的类型
                        html.push(attrName);
                        html.push(" value=\"" + "" + "\" />");
                        ...
                        value !== "" && (_valueSetter[elementId] = value);//使用dom赋值，而不使用字符串拼接方式，避免单引号、双引号等字符转义出问题
                        html.push(listHtml);
    ...
    //@input 输入的数据
    //@conf 字段的新配置，可以不设，若设置，则将与原字段配置merge
